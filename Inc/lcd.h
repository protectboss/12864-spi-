...
#define SPI_SCK_0  	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5,GPIO_PIN_RESET)    // 设置sck接口到PB5   清零
#define SPI_SCK_1  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5,GPIO_PIN_SET)       //置位
#define SPI_SDA_0  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_RESET)       // 设置SDA接口到PB6
#define SPI_SDA_1  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_SET) 
#define SPI_FSO  	(GPIOB->IDR&0X0080)				//字库芯片数据输出脚到PB7
#define SPI_RST_0  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_8,GPIO_PIN_RESET)       // 设置RST接口到PB8
#define SPI_RST_1  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_8,GPIO_PIN_SET)
#define SPI_DC_0   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_RESET)      // 设置DC接口到PB9
#define SPI_DC_1   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_SET)
#define SPI_CS_0   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_RESET)    // 设置CS接口到PB12
#define SPI_CS_1   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_SET)
#define SPI_CS2_0  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_13,GPIO_PIN_RESET)    // 设置CS2  字库芯片 接口到PB13  
#define SPI_CS2_1  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_13,GPIO_PIN_SET)
//#define BL_0  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_RESET)    // 设置BL接口到PB14
//#define BL_1  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_SET)
#define BL_0  GPIOB->BRR=0X4000    // 设置BL接口到PB14
